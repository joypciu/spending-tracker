...
def main() -> None:
    ...
    try:
        ...
        for needle in ("core.js", "view-overview", "palette", "search-all", "make-recurring", "lock-gate", "wallets", "skip-recurring", "repeat-last", "dismiss-banner", "wallet-starts", "amount-chips", "modal-duplicate", "clear-filters", "density-compact", "copy-summary", "week-start", "date-locale"):
